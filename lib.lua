...
local mainui = MN_LIB:CreateUI()

local tab = mainui:Create_Tab("Farms")

local drop = tab:Create_Dropdown("nieahawfd", 200)

drop:Create_Button("ANWD", function()
	print("imdead")
end)

drop:Create_Toggle("ANWD", false, function(w)
	if w then
		print("on")
	else
		print("off")
...
drop:Create_TextBox("AWDAWD", function(w)
	print(w)
end)

drop:Create_Slider("REAL", 50, 100, function(w)
	print(w)
end)

tab:Create_Seperator()

tab:Create_Button("REAL", function()
	MN_LIB:Create_Noti("Item Spawned", "The Arrow Spawned")
end)

tab:Create_Slider("REAL", 50, 100, function(w)
	print(w)
end)

tab:Create_TextBox("AWDAWD", function(w)
	print(w)
end)

tab:Create_Toggle("REAL", true, function(w)
	if w then
		print("on")
	else
		print("off")
...
local awdawd = mainui:Create_Tab("Items")

awdawd:Create_Toggle("REAL", false, function(w)
	if w then
		print("on")
	else
		print("off")
